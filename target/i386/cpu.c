...
FeatureWordInfo feature_word_info[FEATURE_WORDS] = {
    ...
    [FEAT_VMX_EXIT_CTLS] = {
        ...
        .feat_names = {
            ...
            "vmx-exit-save-cet-ctl", "vmx-exit-load-pkrs", NULL, "vmx-exit-secondary-ctls",
        },
        .msr = {
    ...
    [FEAT_VMX_ENTRY_CTLS] = {
        ...
        .feat_names = {
            ...
            "vmx-entry-load-cet-ctl", NULL, "vmx-entry-load-pkrs", "vmx-entry-load-fred",
            NULL, NULL, NULL, NULL,
            NULL, NULL, NULL, NULL,
        },
        .msr = {
...
static void x86_cpu_enable_xsave_components(X86CPU *cpu)
{
    ...
    /* Only request permission for fisrt vcpu. */
...
static void x86_cpu_post_initfn(Object *obj)
{
    ...
    if (first) {
        ...
        supported_xss =
            ((uint64_t) x86_cpu_get_supported_feature_word(NULL, FEAT_XSAVE_XSS_HI) << 32) |
